      ...
      <g transform="matrix(1.3333333 0 0 -1.3333333 0 640)">
        ...
        <g clipPath="url(#a)">
          ...
          <path
            ...
            //"#94c4c8"
          />
          <path d="m800 160h-160v160h160z" fill="#7e89bd" />
          <path
            d="m800 240h-160v80h160z"
            fill={spectrum2}
            //"#f6f2e2"
          />
          <path d="m400 320h-80v80h80z" fill="#7e89bd" />
          <path d="m480 400h-80v80h80z" fill="#7e89bd" />
          <path d="m640 320h-160v160h160z" fill="#292625" />
          <path
          ...
          <path d="m320 160h-160v160h160z" fill="#7e89bd" />
          <path
          ...
          />
          <path d="m480 160h-160v160h160z" fill="#ffc65f" />
          <path
            d="m0 0-80 80-80-80z"
            fill="#292625"
          ...
          />
          <path d="m640 160h-160v160h160z" fill="#94c4c8" />
          <path
          ...
          <path d="m320 0h-160v160h160z" fill="#292625" />
          <path
          ...
          />
          <path d="m160 320h-160v160h160z" fill="#ffc65f" />
          <path
          ...
          <path
            ...
            transform="translate(80 400)"
          />
          <path d="m480 0h-160v160h160z" fill="#7e89bd" />
          <path
            d="m0 0c0 44.183-35.818 80-80 80v-160c44.182 0 80 35.817 80 80"
            fill="#f6f2e2"
          ...
          <path
            ...
            transform="translate(400 80)"
          />
          <path d="m640 0h-160v160h160z" fill="#f6f2e2" />
          ...
          />
          <path d="m160 0h-160v160h160z" fill="#ffc65f" />
          <path
          ...
          />
          <path d="m800 0h-160v160h160z" fill="#292625" />
          <path
          ...
          />
          <path d="m160 160h-160v160h160z" fill="#7e89bd" />
          <path d="m80 240h-80v80h80z" fill="#f6f2e2" />
          <path d="m160 160h-80v80h80z" fill="#f6f2e2" />
          <path
            d="m0 0 80-80v80z"
            fill="#94c4c8"
